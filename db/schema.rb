...
ActiveRecord::Schema.define(:version => 20130505201004) do
  ...
  add_index "images", ["image_processing"], :name => "index_images_on_image_processing"
  add_index "images", ["image_tmp"], :name => "index_images_on_image_tmp"
